...
function SingleVerb() {
    ...
    rechercheVerb = datass.filter(element => element.conjugated_forms[0][1].split(" ")[1] === verbSingleOne || element.conjugated_forms[1][1] === verbSingleOne || element.conjugated_forms[1][1] === verbSingleOne || element.conjugated_forms[2][1] === verbSingleOne)
